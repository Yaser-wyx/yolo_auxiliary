...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    save_dir, epochs, batch_size, weights, single_cls, evolve, data, cfg, resume, noval, nosave, workers, freeze, limit_data \
    ...
    if with_auxiliary:
        ...
        auxiliary_model = \
            Model(auxiliary_model_cfg, ch=3, nc=nc, anchors=hyp.get('anchors'), is_auxiliary=True).to(device)
    ...
    train_loader, dataset = create_dataloader(train_path, imgsz, batch_size // WORLD_SIZE, gs, single_cls,
                                              ...
                                              prefix=colorstr('train: '), shuffle=True, limit_data=limit_data)
